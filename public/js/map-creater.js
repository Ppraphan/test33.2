...
function initialize() {
  var goo = google.maps,
    map_in = new goo.Map(document.getElementById('map_in'), {
      zoom: 16,
      center: new goo.LatLng(14.0342587,100.7237926)
    }),
  ...
  //     }
  //   }
  //   this.shapes = IO.OUT(JSON.parse('[{"type":"CIRCLE","id":null,"radius":541.2157603774151,"geometry":[14.035657350010112,100.72660355504763]}]'), map_out);
  //   // รูปแบบการเก็บข้อมูล
  //   // this.shapes = IO.OUT(JSON.parse('[{"type":"POLYGON","id":null,"geometry":["mmttAqpxeRT}@K_Fi@s@"]}]'), map_out);
  // });
