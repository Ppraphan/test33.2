...
$(document).ready(function() {
      $('#id_edituserinfo').click(function() {

        document.getElementById("id_confirmEditInfo").classList.remove("hide");
        document.getElementById("id_edituserinfo").classList.add("hide");

        $("#formMyinfo :input").prop("disabled", false);
        $("#formMyinfo :select").prop("disabled", false);
        $("#formMyinfo :radio").prop("disabled", false);
